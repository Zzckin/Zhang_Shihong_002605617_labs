...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        int selectedRowIndex = tblProductCatalog.getSelectedRow();
        if (selectedRowIndex < 0) {
            JOptionPane.showMessageDialog(this, "select a order item");
            return;
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "check modified quantity field");
            return;
        }

        int oldQuant = item.getQuantity();
        if (item.getProduct().getAvail() + oldQuant < quant) {
            JOptionPane.showMessageDialog(this, "check avail");
            return;
        }
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "check price and quantity field");
            return;
        }
